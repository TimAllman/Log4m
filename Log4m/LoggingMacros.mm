 ...
 */
void macro_force_log(Logger* logger, int logLevel, NSString* message, const char* filename,
                     int line, const char* function)
{
    ...
    log4cplus::detail::macro_forced_log(cLogger, logLevel, msg, filename, line, function);
}
